    ...
    if (productosCarritoStoredData) {
      ...
      if (productosCarritoParsed instanceof Array) {
        localStorage.setItem(
          "productosCarrito",
          JSON.stringify([...productosCarritoParsed, {...product, productoCarritoId: new Date().getTime()}])
        );
      }
    } else {
      localStorage.setItem("productosCarrito", JSON.stringify([{...product, productoCarritoId: new Date().getTime()}]));
    }
